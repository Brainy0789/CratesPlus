...
HXLINE(3597)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
HXLINE(3599)						this->setSelection(0,this->_hx___text.length);
            			...
            			break;
            			case (int)99: {
HXLINE(3546)				if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
HXLINE(3548)					bool _hx_tmp1;
HXDLIN(3548)					if ((this->_hx___caretIndex != this->_hx___selectionIndex)) {
HXLINE(3548)						_hx_tmp1 = !(this->get_displayAsPassword());
            					}
            					else {
HXLINE(3548)						_hx_tmp1 = false;
            					}
HXDLIN(3548)					if (_hx_tmp1) {
...
HXDLIN(3591)					( ( ::openfl::_Vector::ObjectVector)(this1) )->get((this->_hx___textEngine->textFormatRanges->get_length() - 1)).StaticCast<  ::openfl::text::_internal::TextFormatRange >()->end = this->_hx___text.length;
            			...
            			break;
            			case (int)120: {
HXLINE(3557)				if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
HXLINE(3559)					bool _hx_tmp2;
HXDLIN(3559)					if ((this->_hx___caretIndex != this->_hx___selectionIndex)) {
HXLINE(3559)						_hx_tmp2 = !(this->get_displayAsPassword());
            					}
            					else {
HXLINE(3559)						_hx_tmp2 = false;
            					}
HXDLIN(3559)					if (_hx_tmp2) {
...
HXLINE(3564)						this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("change",70,91,72,b7),true,null()));
            			...
            			break;
            			case (int)127: {
HXLINE(3424)				bool _hx_tmp3;
HXDLIN(3424)				if ((this->_hx___selectionIndex == this->_hx___caretIndex)) {
HXLINE(3424)					_hx_tmp3 = (this->_hx___caretIndex < this->_hx___text.length);
            				}
            				else {
HXLINE(3424)					_hx_tmp3 = false;
            				}
HXDLIN(3424)				if (_hx_tmp3) {
...
HXLINE(3511)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
...
HXLINE(3460)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
...
HXLINE(3443)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
...
HXLINE(3477)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
...
HXLINE(3494)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
