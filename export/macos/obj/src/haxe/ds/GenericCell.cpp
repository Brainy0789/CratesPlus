...
HX_DEFINE_STACK_FRAME(_hx_pos_9f4493ecaa2a865a_37_new,"haxe.ds.GenericCell","new",0x14fd4914,"haxe.ds.GenericCell.new","/Users/michaelpurdy/homebrew/lib/haxe/std/haxe/ds/GenericStack.hx",37,0x2587213b)
namespace haxe{
namespace ds{

void GenericCell_obj::__construct( ::Dynamic elt, ::haxe::ds::GenericCell next){
            	HX_STACKFRAME(&_hx_pos_9f4493ecaa2a865a_37_new)
