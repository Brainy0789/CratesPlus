...
HX_DEFINE_STACK_FRAME(_hx_pos_062ab3acc16f2a64_78_new,"haxe.ds._GenericStack.GenericStackIterator","new",0xd4415186,"haxe.ds._GenericStack.GenericStackIterator.new","/Users/michaelpurdy/homebrew/lib/haxe/std/haxe/ds/GenericStack.hx",78,0x2587213b)
HX_LOCAL_STACK_FRAME(_hx_pos_062ab3acc16f2a64_68_hasNext,"haxe.ds._GenericStack.GenericStackIterator","hasNext",0x78c2b193,"haxe.ds._GenericStack.GenericStackIterator.hasNext","/Users/michaelpurdy/homebrew/lib/haxe/std/haxe/ds/GenericStack.hx",68,0x2587213b)
HX_LOCAL_STACK_FRAME(_hx_pos_062ab3acc16f2a64_71_next,"haxe.ds._GenericStack.GenericStackIterator","next",0xe4e6050d,"haxe.ds._GenericStack.GenericStackIterator.next","/Users/michaelpurdy/homebrew/lib/haxe/std/haxe/ds/GenericStack.hx",71,0x2587213b)
namespace haxe{
namespace ds{
namespace _GenericStack{

void GenericStackIterator_obj::__construct( ::haxe::ds::GenericCell head){
            	HX_STACKFRAME(&_hx_pos_062ab3acc16f2a64_78_new)
...
bool GenericStackIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_062ab3acc16f2a64_68_hasNext)
HXDLIN(  68)		return ::hx::IsNotNull( this->current );
            	}


 ::Dynamic GenericStackIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_062ab3acc16f2a64_71_next)
