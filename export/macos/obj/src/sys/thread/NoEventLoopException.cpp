...
HX_DEFINE_STACK_FRAME(_hx_pos_782ebbfb5bd6756b_7_new,"sys.thread.NoEventLoopException","new",0x6e47ae47,"sys.thread.NoEventLoopException.new","/Users/michaelpurdy/homebrew/lib/haxe/std/sys/thread/NoEventLoopException.hx",7,0xd45ebb24)
namespace sys{
namespace thread{
...
void NoEventLoopException_obj::__construct(::String __o_msg, ::haxe::Exception previous){
            	...
            	HX_STACKFRAME(&_hx_pos_782ebbfb5bd6756b_7_new)
